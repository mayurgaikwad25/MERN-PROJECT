  ...
  const onSubmit = async (data) => {
    ...
    if(hostingImg.data.success) {
      const menuItem = {
        ...
        recipe: data.recipe,
        image: hostingImg.data.data.display_url, // Get the image URL from response
      };

      const postMenuItem = await axiosSecure.patch(`/menu/${item._id}`, menuItem); // Ensure awaiting the request
      if (postMenuItem) {
