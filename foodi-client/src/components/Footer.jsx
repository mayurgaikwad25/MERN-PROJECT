  ...
  return (
    <div>
        ...
        <aside>
            ...
            <p className='py-5 md:w-40'>Savor the artistry where every dish is a culinary masterpiece</p>
        </aside>
        <nav>
        ...
        <nav>
          ...
          <a className="link link-hover">+91 9582489603</a>
          <a className="link link-hover">Social media</a>
        </nav>
        </footer>
        <hr />
        <footer className="footer footer-center  text-base-content rounded p-10 py-5">
            <nav>
